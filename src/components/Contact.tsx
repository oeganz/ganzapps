...
const socials = [
  ...
  {
    href: "https://t.me/ganzapps",
    label: "Telegram",
    icon: TelegramIcon,
  },
  {
    href: "https://linkedin.com/company/ganzapps",
    label: "LinkedIn",
    icon: LinkedInIcon,
  },
];
          ...
          <div className="flex items-center justify-center gap-5">
            {socials.map((s) => (
              <a
                ...
                rel="noopener noreferrer"
                aria-label={s.label}
                className="w-10 h-10 rounded-xl glass-card flex items-center justify-center text-gray-500 hover:text-brand hover:border-brand/30 transition-all duration-300"
              >
                <s.icon />
              </a>
            ))}
